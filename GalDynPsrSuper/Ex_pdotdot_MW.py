...
from . import ExGal_pdot_MW
from . import ExShk_pdot



def pdotdotexMW(ldeg,bdeg,dkpc,mul,mub,p,pdotobs,vrad):
    ...
    pex_pl = ExGal_pdot_MW.Expl(ldeg, bdeg, dkpc)

    pex_z = ExGal_pdot_MW.Exz(ldeg, bdeg, dkpc)
